...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('assets/img/ec.png') }}"/></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('our_solutions') }}">Our Solution</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('success_stories') }}">Succes Story</a></li>
